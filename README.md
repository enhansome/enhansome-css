...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,884 | 🐛 4,679 | 🌐 Bikeshed | 📅 2026-09-25 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,976 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-24 - Transforming styles with JS plugins.
* [Rework](https://github.com/reworkcss/rework) ⭐ 2,737 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-04 - Plugin framework for CSS preprocessing in Node.js.
* [CSSTree](https://github.com/csstree/csstree) ⭐ 2,123 | 🐛 77 | 🌐 JavaScript | 📅 2026-09-16 - Detailed CSS parser with syntax validator.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,976 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-24 - Transforming CSS with JS plugins.
...
* [Sass](https://github.com/sass/sass) ⭐ 15,374 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-24 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,674 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-25 - A utility-first CSS framework for rapid UI development.
...
* [Scalable-css-reading-list](https://github.com/davidtheclark/scalable-css-reading-list) ⭐ 1,545 | 🐛 3 | 📅 2024-06-21
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,294 | 🐛 807 | 🌐 TypeScript | 📅 2026-09-25 by Microsoft
...
* [Styledown](https://github.com/styledown/styledown) ⭐ 666 | 🐛 21 | 🌐 JavaScript | 📅 2017-07-21
...
* [Styled-components](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-24
...
* [Selectivizr](https://github.com/keithclark/selectivizr) ⭐ 1,686 | 🐛 61 | 🌐 JavaScript | 📅 2017-02-18 - A JavaScript utility that emulates CSS3 pseudo-classes and attribute selectors in Internet Explorer 6-8.
