...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,868 | 🐛 4,671 | 🌐 Bikeshed | 📅 2026-08-27 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,983 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-26 - Transforming styles with JS plugins.
* [Rework](https://github.com/reworkcss/rework) ⭐ 2,740 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-04 - Plugin framework for CSS preprocessing in Node.js.
* [CSSTree](https://github.com/csstree/csstree) ⭐ 2,118 | 🐛 72 | 🌐 JavaScript | 📅 2026-03-05 - Detailed CSS parser with syntax validator.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,983 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-26 - Transforming CSS with JS plugins.
* [LESS](https://github.com/less/less.js) ⭐ 17,029 | 🐛 182 | 🌐 JavaScript | 📅 2026-08-13 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,359 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-14 - A utility-first CSS framework for rapid UI development.
...
*[You can find more frameworks at "awesome-css-frameworks"](https://github.com/troxler/awesome-css-frameworks) ⭐ 9,499 | 🐛 4 | 🌐 CSS | 📅 2026-06-08*
...
* [Normalize](https://github.com/necolas/normalize.css) ⭐ 53,516 | 🐛 75 | 🌐 CSS | 📅 2024-06-12 - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements.
* [Sanitize.css](https://github.com/jonathantneal/sanitize.css/) ⭐ 5,302 | 🐛 22 | 🌐 CSS | 📅 2026-03-26 - A set of CSS rules that style with today’s best practices out-of-the-box.
...
* [Idiomatic CSS](https://github.com/necolas/idiomatic-css) ⭐ 6,652 | 🐛 7 | 📅 2022-12-21 by [Nicolas Gallagher](https://twitter.com/necolas)
...
* [Dropbox (S)CSS Style Guide](https://github.com/dropbox/css-style-guide) ⭐ 1,215 | 🐛 5 | 📅 2019-11-08 by Dropbox
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,233 | 🐛 767 | 🌐 TypeScript | 📅 2026-08-27 by Microsoft
...
* [Styled-jsx](https://github.com/zeit/styled-jsx) ⭐ 7,777 | 🐛 83 | 🌐 JavaScript | 📅 2026-06-09
...
* [Css-loader](https://github.com/webpack/css-loader) ⭐ 4,321 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-27
* [React-with-styles](https://github.com/airbnb/react-with-styles) ⭐ 1,690 | 🐛 32 | 🌐 JavaScript | 📅 2024-04-12
...
Here is a [CSS in JS techniques comparison](https://github.com/MicheleBertoli/css-in-js) ⭐ 5,476 | 🐛 6 | 🌐 JavaScript | 📅 2024-04-02
...
* [Selectivizr](https://github.com/keithclark/selectivizr) ⭐ 1,688 | 🐛 62 | 🌐 JavaScript | 📅 2017-02-18 - A JavaScript utility that emulates CSS3 pseudo-classes and attribute selectors in Internet Explorer 6-8.
