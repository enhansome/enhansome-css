...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,881 | 🐛 4,675 | 🌐 Bikeshed | 📅 2026-09-14 - Mirror of CSS WG Editor Draft repository.
...
* [CSSTree](https://github.com/csstree/csstree) ⭐ 2,121 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-16 - Detailed CSS parser with syntax validator.
...
* [LESS](https://github.com/less/less.js) ⭐ 17,024 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-16 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
* [Sass](https://github.com/sass/sass) ⭐ 15,372 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-16 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,593 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-08 - A utility-first CSS framework for rapid UI development.
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,277 | 🐛 815 | 🌐 TypeScript | 📅 2026-09-17 by Microsoft
...
\*Good study videos from CSS Must Watch Videos. Some items are quoted from [AllThingsSmitty/must-watch-css](https://github.com/AllThingsSmitty/must-watch-css) ⭐ 4,884 | 🐛 0 | 📅 2025-12-05.
