...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,875 | 🐛 4,658 | 🌐 Bikeshed | 📅 2026-09-04 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,978 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-03 - Transforming styles with JS plugins.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,978 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-03 - Transforming CSS with JS plugins.
* [LESS](https://github.com/less/less.js) ⭐ 17,025 | 🐛 180 | 🌐 JavaScript | 📅 2026-09-05 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
* [Sass](https://github.com/sass/sass) ⭐ 15,371 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-04 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,458 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-02 - A utility-first CSS framework for rapid UI development.
...
*[You can find more frameworks at "awesome-css-frameworks"](https://github.com/troxler/awesome-css-frameworks) ⭐ 9,508 | 🐛 4 | 🌐 CSS | 📅 2026-06-08*
...
* [Normalize](https://github.com/necolas/normalize.css) ⭐ 53,523 | 🐛 75 | 🌐 CSS | 📅 2024-06-12 - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements.
* [Sanitize.css](https://github.com/jonathantneal/sanitize.css/) ⭐ 5,305 | 🐛 22 | 🌐 CSS | 📅 2026-03-26 - A set of CSS rules that style with today’s best practices out-of-the-box.
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,250 | 🐛 787 | 🌐 TypeScript | 📅 2026-09-06 by Microsoft
