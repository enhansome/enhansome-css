...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,876 | 🐛 4,663 | 🌐 Bikeshed | 📅 2026-09-07 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,974 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming styles with JS plugins.
* [Rework](https://github.com/reworkcss/rework) ⭐ 2,740 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-04 - Plugin framework for CSS preprocessing in Node.js.
* [CSSTree](https://github.com/csstree/csstree) ⭐ 2,119 | 🐛 75 | 🌐 JavaScript | 📅 2026-03-05 - Detailed CSS parser with syntax validator.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,974 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming CSS with JS plugins.
* [LESS](https://github.com/less/less.js) ⭐ 17,025 | 🐛 182 | 🌐 JavaScript | 📅 2026-09-07 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,492 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-08 - A utility-first CSS framework for rapid UI development.
...
* [Normalize](https://github.com/necolas/normalize.css) ⭐ 53,524 | 🐛 75 | 🌐 CSS | 📅 2024-06-12 - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements.
...
* [Dropbox (S)CSS Style Guide](https://github.com/dropbox/css-style-guide) ⭐ 1,212 | 🐛 5 | 📅 2019-11-08 by Dropbox
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,256 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-08 by Microsoft
...
* [Styled-components](https://github.com/styled-components/styled-components) ⭐ 41,123 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-05
...
\*Good study videos from CSS Must Watch Videos. Some items are quoted from [AllThingsSmitty/must-watch-css](https://github.com/AllThingsSmitty/must-watch-css) ⭐ 4,885 | 🐛 2 | 📅 2025-12-05.
