...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,878 | 🐛 4,658 | 🌐 Bikeshed | 📅 2026-09-12 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,972 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming styles with JS plugins.
* [Rework](https://github.com/reworkcss/rework) ⭐ 2,737 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-04 - Plugin framework for CSS preprocessing in Node.js.
* [CSSTree](https://github.com/csstree/csstree) ⭐ 2,120 | 🐛 75 | 🌐 JavaScript | 📅 2026-03-05 - Detailed CSS parser with syntax validator.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,972 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming CSS with JS plugins.
...
* [Sass](https://github.com/sass/sass) ⭐ 15,374 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-09 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,516 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-08 - A utility-first CSS framework for rapid UI development.
...
*[You can find more frameworks at "awesome-css-frameworks"](https://github.com/troxler/awesome-css-frameworks) ⭐ 9,514 | 🐛 4 | 🌐 CSS | 📅 2026-06-08*
...
* [ThinkUp CSS Style Guide](https://github.com/ThinkUpLLC/ThinkUp/wiki/Code-Style-Guide:-CSS) ⭐ 3,263 | 🐛 181 | 🌐 PHP | 📅 2017-01-01 by ThinkUp
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,271 | 🐛 806 | 🌐 TypeScript | 📅 2026-09-12 by Microsoft
...
* [Styled-components](https://github.com/styled-components/styled-components) ⭐ 41,102 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-11
* [Styled-jsx](https://github.com/zeit/styled-jsx) ⭐ 7,774 | 🐛 83 | 🌐 JavaScript | 📅 2026-06-09
* [JSS](https://github.com/cssinjs/jss) ⭐ 7,050 | 🐛 225 | 🌐 JavaScript | 📅 2024-08-13
