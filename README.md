...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,879 | 🐛 4,661 | 🌐 Bikeshed | 📅 2026-09-14 - Mirror of CSS WG Editor Draft repository.
...
* [LESS](https://github.com/less/less.js) ⭐ 17,023 | 🐛 183 | 🌐 JavaScript | 📅 2026-09-13 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
* [Sass](https://github.com/sass/sass) ⭐ 15,373 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-14 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,552 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-08 - A utility-first CSS framework for rapid UI development.
...
*[You can find more frameworks at "awesome-css-frameworks"](https://github.com/troxler/awesome-css-frameworks) ⭐ 9,518 | 🐛 4 | 🌐 CSS | 📅 2026-06-08*
...
* [Normalize](https://github.com/necolas/normalize.css) ⭐ 53,522 | 🐛 75 | 🌐 CSS | 📅 2024-06-12 - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements.
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,269 | 🐛 806 | 🌐 TypeScript | 📅 2026-09-14 by Microsoft
