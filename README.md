...
* [W3c/csswg-drafts](https://github.com/w3c/csswg-drafts) ⭐ 4,876 | 🐛 4,661 | 🌐 Bikeshed | 📅 2026-09-09 - Mirror of CSS WG Editor Draft repository.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,975 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming styles with JS plugins.
...
* [CSSOM](https://github.com/NV/CSSOM) ⭐ 757 | 🐛 25 | 🌐 JavaScript | 📅 2023-04-18 - CSS Object Model implemented in pure JavaScript.
...
* [PostCSS](https://github.com/postcss/postcss) ⭐ 28,975 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-08 - Transforming CSS with JS plugins.
* [LESS](https://github.com/less/less.js) ⭐ 17,025 | 🐛 184 | 🌐 JavaScript | 📅 2026-09-07 - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax.
* [Sass](https://github.com/sass/sass) ⭐ 15,371 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-04 - Mature, stable, and powerful professional-grade CSS extension language.
...
* [Tailwindcss](https://github.com/tailwindcss/tailwindcss) ⭐ 97,475 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-08 - A utility-first CSS framework for rapid UI development.
...
* [Idiomatic CSS](https://github.com/necolas/idiomatic-css) ⭐ 6,650 | 🐛 7 | 📅 2022-12-21 by [Nicolas Gallagher](https://twitter.com/necolas)
...
* [Fluent UI](https://github.com/microsoft/fluentui) ⭐ 20,259 | 🐛 799 | 🌐 TypeScript | 📅 2026-09-09 by Microsoft
...
* [Styledocco](https://github.com/jacobrask/styledocco) ⭐ 1,061 | 🐛 48 | 🌐 JavaScript | 📅 2018-02-20
...
* [Styled-components](https://github.com/styled-components/styled-components) ⭐ 41,108 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-08
* [Styled-jsx](https://github.com/zeit/styled-jsx) ⭐ 7,775 | 🐛 83 | 🌐 JavaScript | 📅 2026-06-09
* [JSS](https://github.com/cssinjs/jss) ⭐ 7,053 | 🐛 225 | 🌐 JavaScript | 📅 2024-08-13
...
Here is a [CSS in JS techniques comparison](https://github.com/MicheleBertoli/css-in-js) ⭐ 5,472 | 🐛 6 | 🌐 JavaScript | 📅 2024-04-02
